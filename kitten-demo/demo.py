...
class KittenTTS_1_Onnx:
    def __init__(
        self, model_path="kitten_tts_nano_v0_1.onnx", voices_path="voices.npz"
    ):
...
if __name__ == "__main__":
    tts = KittenTTS_1_Onnx("./model/kitten_tts_nano_v0_1.onnx", "./model/voices.npz")

    text = "a demo test for kitten-tts"

    tts.generate_to_file(text, "demo.wav", voice="expr-voice-5-f")
